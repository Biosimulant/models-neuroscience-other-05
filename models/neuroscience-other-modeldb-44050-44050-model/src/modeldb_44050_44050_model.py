...
"""Auto-generated BioModule wrapper for ModelDB #44050.

Source: modeldb:44050
Original: https://modeldb.science/44050
Standard: other
...
class OtherModeldb44050(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #44050.
    ...
    def __init__(self, model_path: str = "data/44050.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb4405044050Model = OtherModeldb44050
