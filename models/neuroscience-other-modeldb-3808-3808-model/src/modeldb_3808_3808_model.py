...
"""Auto-generated BioModule wrapper for ModelDB #3808.

Source: modeldb:3808
Original: https://modeldb.science/3808
Standard: other
...
class OtherModeldb3808(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3808.
    ...
    def __init__(self, model_path: str = "data/3808.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb38083808Model = OtherModeldb3808
