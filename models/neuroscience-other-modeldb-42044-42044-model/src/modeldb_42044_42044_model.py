...
"""Auto-generated BioModule wrapper for ModelDB #42044.

Source: modeldb:42044
Original: https://modeldb.science/42044
Standard: other
...
class OtherModeldb42044(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #42044.
    ...
    def __init__(self, model_path: str = "data/42044.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb4204442044Model = OtherModeldb42044
