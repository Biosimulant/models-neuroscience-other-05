...
"""Auto-generated BioModule wrapper for ModelDB #136717.

Source: modeldb:136717
Original: https://modeldb.science/136717
Standard: other
...
class OtherModeldb136717(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #136717.
    ...
    def __init__(self, model_path: str = "data/136717.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb136717136717Model = OtherModeldb136717
