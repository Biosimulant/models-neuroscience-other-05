...
"""Auto-generated BioModule wrapper for ModelDB #7399.

Source: modeldb:7399
Original: https://modeldb.science/7399
Standard: other
...
class OtherModeldb7399(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #7399.
    ...
    def __init__(self, model_path: str = "data/7399.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb73997399Model = OtherModeldb7399
