...
"""Auto-generated BioModule wrapper for ModelDB #20756.

Source: modeldb:20756
Original: https://modeldb.science/20756
Standard: other
...
class OtherModeldb20756(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #20756.
    ...
    def __init__(self, model_path: str = "data/20756.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb2075620756Model = OtherModeldb20756
