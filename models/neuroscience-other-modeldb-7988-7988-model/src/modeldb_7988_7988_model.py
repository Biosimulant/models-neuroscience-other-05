...
"""Auto-generated BioModule wrapper for ModelDB #7988.

Source: modeldb:7988
Original: https://modeldb.science/7988
Standard: other
...
class OtherModeldb7988(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #7988.
    ...
    def __init__(self, model_path: str = "data/7988.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb79887988Model = OtherModeldb7988
