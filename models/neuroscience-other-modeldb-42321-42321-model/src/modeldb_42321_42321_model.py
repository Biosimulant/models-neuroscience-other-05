...
"""Auto-generated BioModule wrapper for ModelDB #42321.

Source: modeldb:42321
Original: https://modeldb.science/42321
Standard: other
...
class OtherModeldb42321(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #42321.
    ...
    def __init__(self, model_path: str = "data/42321.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb4232142321Model = OtherModeldb42321
