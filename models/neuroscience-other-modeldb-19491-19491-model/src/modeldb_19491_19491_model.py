...
"""Auto-generated BioModule wrapper for ModelDB #19491.

Source: modeldb:19491
Original: https://modeldb.science/19491
Standard: other
...
class OtherModeldb19491(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #19491.
    ...
    def __init__(self, model_path: str = "data/19491.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb1949119491Model = OtherModeldb19491
