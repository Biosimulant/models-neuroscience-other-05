...
"""Auto-generated BioModule wrapper for Implementation issues in approximate methods for stochastic Hodgkin-Huxley models (Bruce 2007).

Source: modeldb:93315
Original: https://modeldb.science/93315
Standard: other
...
class OtherImplementationIssuesInApproximateMethodsForStochastic(biosim.BioModule):
    """BioModule wrapper for: Implementation issues in approximate methods for stochastic Hodgkin-Huxley models (Bruce 2007)."""

    def __init__(self, model_path: str = "data/93315.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ImplementationIssuesInApproximateMethodsFor93315Model = OtherImplementationIssuesInApproximateMethodsForStochastic
