...
"""Auto-generated BioModule wrapper for Fast population coding (Huys et al. 2007).

Source: modeldb:93394
Original: https://modeldb.science/93394
Standard: other
...
class OtherFastPopulationCodingHuysEtAl2007(biosim.BioModule):
    """Placeholder BioModule wrapper for: Fast population coding (Huys et al. 2007).
    ...
    def __init__(self, model_path: str = "data/93394.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
FastPopulationCodingHuysEtAl200793394Model = OtherFastPopulationCodingHuysEtAl2007
