...
"""Auto-generated BioModule wrapper for ModelDB #2733.

Source: modeldb:2733
Original: https://modeldb.science/2733
Standard: other
...
class OtherModeldb2733(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #2733.
    ...
    def __init__(self, model_path: str = "data/2733.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb27332733Model = OtherModeldb2733
