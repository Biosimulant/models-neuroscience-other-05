...
"""Auto-generated BioModule wrapper for ModelDB #3682.

Source: modeldb:3682
Original: https://modeldb.science/3682
Standard: other
...
class OtherModeldb3682(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3682.
    ...
    def __init__(self, model_path: str = "data/3682.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb36823682Model = OtherModeldb3682
