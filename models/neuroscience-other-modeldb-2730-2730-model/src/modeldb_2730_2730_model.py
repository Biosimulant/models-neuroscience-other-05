...
"""Auto-generated BioModule wrapper for ModelDB #2730.

Source: modeldb:2730
Original: https://modeldb.science/2730
Standard: other
...
class OtherModeldb2730(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #2730.
    ...
    def __init__(self, model_path: str = "data/2730.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb27302730Model = OtherModeldb2730
