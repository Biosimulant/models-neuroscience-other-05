...
"""Auto-generated BioModule wrapper for ModelDB #29942.

Source: modeldb:29942
Original: https://modeldb.science/29942
Standard: other
...
class OtherModeldb29942(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #29942.
    ...
    def __init__(self, model_path: str = "data/29942.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb2994229942Model = OtherModeldb29942
