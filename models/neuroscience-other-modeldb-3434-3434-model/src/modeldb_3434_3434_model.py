...
"""Auto-generated BioModule wrapper for ModelDB #3434.

Source: modeldb:3434
Original: https://modeldb.science/3434
Standard: other
...
class OtherModeldb3434(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3434.
    ...
    def __init__(self, model_path: str = "data/3434.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb34343434Model = OtherModeldb3434
