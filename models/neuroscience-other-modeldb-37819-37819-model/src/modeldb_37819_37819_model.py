...
"""Auto-generated BioModule wrapper for ModelDB #37819.

Source: modeldb:37819
Original: https://modeldb.science/37819
Standard: other
...
class OtherModeldb37819(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #37819.
    ...
    def __init__(self, model_path: str = "data/37819.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb3781937819Model = OtherModeldb37819
