...
"""Auto-generated BioModule wrapper for ModelDB #36956.

Source: modeldb:36956
Original: https://modeldb.science/36956
Standard: other
...
class OtherModeldb36956(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #36956.
    ...
    def __init__(self, model_path: str = "data/36956.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb3695636956Model = OtherModeldb36956
