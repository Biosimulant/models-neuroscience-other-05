...
"""Auto-generated BioModule wrapper for ModelDB #18502.

Source: modeldb:18502
Original: https://modeldb.science/18502
Standard: other
...
class OtherModeldb18502(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #18502.
    ...
    def __init__(self, model_path: str = "data/18502.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb1850218502Model = OtherModeldb18502
