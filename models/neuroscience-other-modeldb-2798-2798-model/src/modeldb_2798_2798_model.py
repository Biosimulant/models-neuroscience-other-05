...
"""Auto-generated BioModule wrapper for ModelDB #2798.

Source: modeldb:2798
Original: https://modeldb.science/2798
Standard: other
...
class OtherModeldb2798(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #2798.
    ...
    def __init__(self, model_path: str = "data/2798.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb27982798Model = OtherModeldb2798
