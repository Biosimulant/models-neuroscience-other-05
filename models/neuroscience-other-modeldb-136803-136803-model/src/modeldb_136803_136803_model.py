...
"""Auto-generated BioModule wrapper for ModelDB #136803.

Source: modeldb:136803
Original: https://modeldb.science/136803
Standard: other
...
class OtherModeldb136803(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #136803.
    ...
    def __init__(self, model_path: str = "data/136803.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb136803136803Model = OtherModeldb136803
