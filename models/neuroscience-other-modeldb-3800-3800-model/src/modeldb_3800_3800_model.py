...
"""Auto-generated BioModule wrapper for ModelDB #3800.

Source: modeldb:3800
Original: https://modeldb.science/3800
Standard: other
...
class OtherModeldb3800(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3800.
    ...
    def __init__(self, model_path: str = "data/3800.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb38003800Model = OtherModeldb3800
