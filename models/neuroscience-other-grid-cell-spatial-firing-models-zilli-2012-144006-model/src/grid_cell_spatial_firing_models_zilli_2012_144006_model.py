...
"""Auto-generated BioModule wrapper for Grid cell spatial firing models (Zilli 2012).

Source: modeldb:144006
Original: https://modeldb.science/144006
Standard: other
...
class OtherGridCellSpatialFiringModelsZilli2012(biosim.BioModule):
    """Placeholder BioModule wrapper for: Grid cell spatial firing models (Zilli 2012).
    ...
    def __init__(self, model_path: str = "data/144006.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
GridCellSpatialFiringModelsZilli2012144006Model = OtherGridCellSpatialFiringModelsZilli2012
