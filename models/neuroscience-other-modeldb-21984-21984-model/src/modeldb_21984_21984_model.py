...
"""Auto-generated BioModule wrapper for ModelDB #21984.

Source: modeldb:21984
Original: https://modeldb.science/21984
Standard: other
...
class OtherModeldb21984(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #21984.
    ...
    def __init__(self, model_path: str = "data/21984.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb2198421984Model = OtherModeldb21984
