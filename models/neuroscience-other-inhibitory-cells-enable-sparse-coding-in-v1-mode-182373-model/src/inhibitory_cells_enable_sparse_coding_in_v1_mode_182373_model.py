...
"""Auto-generated BioModule wrapper for Inhibitory cells enable sparse coding in V1 model (King et al. 2013).

Source: modeldb:182373
Original: https://modeldb.science/182373
Standard: other
...
class OtherInhibitoryCellsEnableSparseCodingInV1ModelKingEt(biosim.BioModule):
    """BioModule wrapper for: Inhibitory cells enable sparse coding in V1 model (King et al. 2013)."""

    def __init__(self, model_path: str = "data/182373.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
InhibitoryCellsEnableSparseCodingInV1Mode182373Model = OtherInhibitoryCellsEnableSparseCodingInV1ModelKingEt
