...
"""Auto-generated BioModule wrapper for Method for deriving general HH neuron model`s spiking input-output relation (Soudry & Meir 2014).

Source: modeldb:144993
Original: https://modeldb.science/144993
Standard: other
...
class OtherMethodForDerivingGeneralHhNeuronModelSSpikingInput(bsim.BioModule):
    """Placeholder BioModule wrapper for: Method for deriving general HH neuron model`s spiking input-output relation (Soudry & Meir 2014).
...
MethodForDerivingGeneralHhNeuronModelSSp144993Model = OtherMethodForDerivingGeneralHhNeuronModelSSpikingInput
