...
"""Auto-generated BioModule wrapper for ModelDB #20014.

Source: modeldb:20014
Original: https://modeldb.science/20014
Standard: other
...
class OtherModeldb20014(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #20014.
    ...
    def __init__(self, model_path: str = "data/20014.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb2001420014Model = OtherModeldb20014
