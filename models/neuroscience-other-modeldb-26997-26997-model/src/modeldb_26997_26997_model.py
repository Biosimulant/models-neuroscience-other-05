...
"""Auto-generated BioModule wrapper for ModelDB #26997.

Source: modeldb:26997
Original: https://modeldb.science/26997
Standard: other
...
class OtherModeldb26997(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #26997.
    ...
    def __init__(self, model_path: str = "data/26997.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb2699726997Model = OtherModeldb26997
