...
"""Auto-generated BioModule wrapper for Homosynaptic plasticity in the tail withdrawal circuit (TWC) of Aplysia (Baxter and Byrne 2006).

Source: modeldb:83472
Original: https://modeldb.science/83472
Standard: other
...
class OtherHomosynapticPlasticityInTheTailWithdrawalCircuitTwc(bsim.BioModule):
    """Placeholder BioModule wrapper for: Homosynaptic plasticity in the tail withdrawal circuit (TWC) of Aplysia (Baxter and Byrne 2006).
...
HomosynapticPlasticityInTheTailWithdrawalC83472Model = OtherHomosynapticPlasticityInTheTailWithdrawalCircuitTwc
