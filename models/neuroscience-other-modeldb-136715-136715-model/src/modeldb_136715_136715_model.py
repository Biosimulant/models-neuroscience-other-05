...
"""Auto-generated BioModule wrapper for ModelDB #136715.

Source: modeldb:136715
Original: https://modeldb.science/136715
Standard: other
...
class OtherModeldb136715(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #136715.
    ...
    def __init__(self, model_path: str = "data/136715.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb136715136715Model = OtherModeldb136715
