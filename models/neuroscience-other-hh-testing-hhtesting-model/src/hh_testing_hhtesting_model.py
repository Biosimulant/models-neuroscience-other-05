...
"""Auto-generated BioModule wrapper for hh-testing.

Source: opensourcebrain:hh-testing
Original: https://github.com/OpenSourceBrain/hh-testing
Standard: other
...
class OtherHhTesting(biosim.BioModule):
    """Placeholder BioModule wrapper for: hh-testing.
...
HhTestingHhtestingModel = OtherHhTesting
