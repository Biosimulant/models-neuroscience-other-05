...
"""Auto-generated BioModule wrapper for ModelDB #2488.

Source: modeldb:2488
Original: https://modeldb.science/2488
Standard: other
...
class OtherModeldb2488(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #2488.
    ...
    def __init__(self, model_path: str = "data/2488.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb24882488Model = OtherModeldb2488
