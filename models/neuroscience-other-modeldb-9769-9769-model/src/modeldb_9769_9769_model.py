...
"""Auto-generated BioModule wrapper for ModelDB #9769.

Source: modeldb:9769
Original: https://modeldb.science/9769
Standard: other
...
class OtherModeldb9769(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #9769.
    ...
    def __init__(self, model_path: str = "data/9769.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb97699769Model = OtherModeldb9769
