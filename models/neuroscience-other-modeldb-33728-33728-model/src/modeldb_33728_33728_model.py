...
"""Auto-generated BioModule wrapper for ModelDB #33728.

Source: modeldb:33728
Original: https://modeldb.science/33728
Standard: other
...
class OtherModeldb33728(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #33728.
    ...
    def __init__(self, model_path: str = "data/33728.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb3372833728Model = OtherModeldb33728
