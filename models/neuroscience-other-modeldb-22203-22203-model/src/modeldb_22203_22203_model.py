...
"""Auto-generated BioModule wrapper for ModelDB #22203.

Source: modeldb:22203
Original: https://modeldb.science/22203
Standard: other
...
class OtherModeldb22203(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #22203.
    ...
    def __init__(self, model_path: str = "data/22203.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb2220322203Model = OtherModeldb22203
