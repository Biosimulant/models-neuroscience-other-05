...
"""Auto-generated BioModule wrapper for ModelDB #8210.

Source: modeldb:8210
Original: https://modeldb.science/8210
Standard: other
...
class OtherModeldb8210(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #8210.
    ...
    def __init__(self, model_path: str = "data/8210.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb82108210Model = OtherModeldb8210
