...
"""Auto-generated BioModule wrapper for Linear vs non-linear integration in CA1 oblique dendrites (Gómez González et al. 2011).

Source: modeldb:144450
Original: https://modeldb.science/144450
Standard: other
...
class OtherLinearVsNonLinearIntegrationInCa1ObliqueDendrites(bsim.BioModule):
    """Placeholder BioModule wrapper for: Linear vs non-linear integration in CA1 oblique dendrites (Gómez González et al. 2011).
...
LinearVsNonLinearIntegrationInCa1Oblique144450Model = OtherLinearVsNonLinearIntegrationInCa1ObliqueDendrites
