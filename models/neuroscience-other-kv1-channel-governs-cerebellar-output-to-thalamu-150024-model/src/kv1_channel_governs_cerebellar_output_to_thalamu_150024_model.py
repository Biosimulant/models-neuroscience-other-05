...
"""Auto-generated BioModule wrapper for KV1 channel governs cerebellar output to thalamus (Ovsepian et al. 2013).

Source: modeldb:150024
Original: https://modeldb.science/150024
Standard: other
...
class OtherKv1ChannelGovernsCerebellarOutputToThalamusOvsepian(biosim.BioModule):
    """BioModule wrapper for: KV1 channel governs cerebellar output to thalamus (Ovsepian et al. 2013).""""""

    def __init__(self, model_path: str = "data/150024.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kv1ChannelGovernsCerebellarOutputToThalamu150024Model = OtherKv1ChannelGovernsCerebellarOutputToThalamusOvsepian
