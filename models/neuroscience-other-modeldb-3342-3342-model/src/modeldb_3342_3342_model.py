...
"""Auto-generated BioModule wrapper for ModelDB #3342.

Source: modeldb:3342
Original: https://modeldb.science/3342
Standard: other
...
class OtherModeldb3342(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3342.
    ...
    def __init__(self, model_path: str = "data/3342.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb33423342Model = OtherModeldb3342
