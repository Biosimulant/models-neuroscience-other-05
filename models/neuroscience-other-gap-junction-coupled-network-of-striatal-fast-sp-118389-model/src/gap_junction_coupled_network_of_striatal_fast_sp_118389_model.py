...
"""Auto-generated BioModule wrapper for Gap junction coupled network of striatal fast spiking interneurons (Hjorth et al. 2009).

Source: modeldb:118389
Original: https://modeldb.science/118389
Standard: other
...
class OtherGapJunctionCoupledNetworkOfStriatalFastSpiking(bsim.BioModule):
    """Placeholder BioModule wrapper for: Gap junction coupled network of striatal fast spiking interneurons (Hjorth et al. 2009).
...
GapJunctionCoupledNetworkOfStriatalFastSp118389Model = OtherGapJunctionCoupledNetworkOfStriatalFastSpiking
