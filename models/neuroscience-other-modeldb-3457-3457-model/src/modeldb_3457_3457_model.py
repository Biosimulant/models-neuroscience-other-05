...
"""Auto-generated BioModule wrapper for ModelDB #3457.

Source: modeldb:3457
Original: https://modeldb.science/3457
Standard: other
...
class OtherModeldb3457(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3457.
    ...
    def __init__(self, model_path: str = "data/3457.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb34573457Model = OtherModeldb3457
