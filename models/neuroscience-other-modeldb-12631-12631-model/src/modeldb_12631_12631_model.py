...
"""Auto-generated BioModule wrapper for ModelDB #12631.

Source: modeldb:12631
Original: https://modeldb.science/12631
Standard: other
...
class OtherModeldb12631(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #12631.
    ...
    def __init__(self, model_path: str = "data/12631.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb1263112631Model = OtherModeldb12631
