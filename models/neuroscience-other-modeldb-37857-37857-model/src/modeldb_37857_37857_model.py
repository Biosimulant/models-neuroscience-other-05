...
"""Auto-generated BioModule wrapper for ModelDB #37857.

Source: modeldb:37857
Original: https://modeldb.science/37857
Standard: other
...
class OtherModeldb37857(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #37857.
    ...
    def __init__(self, model_path: str = "data/37857.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb3785737857Model = OtherModeldb37857
