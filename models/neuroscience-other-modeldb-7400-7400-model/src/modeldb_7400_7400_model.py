...
"""Auto-generated BioModule wrapper for ModelDB #7400.

Source: modeldb:7400
Original: https://modeldb.science/7400
Standard: other
...
class OtherModeldb7400(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #7400.
    ...
    def __init__(self, model_path: str = "data/7400.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb74007400Model = OtherModeldb7400
