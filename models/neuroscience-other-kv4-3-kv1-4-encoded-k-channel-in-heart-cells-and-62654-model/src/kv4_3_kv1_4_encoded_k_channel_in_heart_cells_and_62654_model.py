...
"""Auto-generated BioModule wrapper for Kv4.3, Kv1.4 encoded K channel in heart cells & tachy. (Winslow et al 1999, Greenstein et al 2000).

Source: modeldb:62654
Original: https://modeldb.science/62654
Standard: other
...
class OtherKv43Kv14EncodedKChannelInHeartCellsTachyWinslow(biosim.BioModule):
    """BioModule wrapper for: Kv4.3, Kv1.4 encoded K channel in heart cells & tachy. (Winslow et al 1999, Greenstein et al 2000).""""""

    def __init__(self, model_path: str = "data/62654.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Kv43Kv14EncodedKChannelInHeartCellsAnd62654Model = OtherKv43Kv14EncodedKChannelInHeartCellsTachyWinslow
