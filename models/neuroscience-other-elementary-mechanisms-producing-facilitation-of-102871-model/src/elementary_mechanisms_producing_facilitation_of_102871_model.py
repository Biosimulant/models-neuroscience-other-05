...
"""Auto-generated BioModule wrapper for Elementary mechanisms producing facilitation of Cav2.1 (P/Q-type) channels.

Source: modeldb:102871
Original: https://modeldb.science/102871
Standard: other
...
class OtherElementaryMechanismsProducingFacilitationOfCav21PQ(biosim.BioModule):
    """BioModule wrapper for: Elementary mechanisms producing facilitation of Cav2.1 (P/Q-type) channels."""

    def __init__(self, model_path: str = "data/102871.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ElementaryMechanismsProducingFacilitationOf102871Model = OtherElementaryMechanismsProducingFacilitationOfCav21PQ
