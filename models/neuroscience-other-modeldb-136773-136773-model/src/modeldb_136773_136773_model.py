...
"""Auto-generated BioModule wrapper for ModelDB #136773.

Source: modeldb:136773
Original: https://modeldb.science/136773
Standard: other
...
class OtherModeldb136773(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #136773.
    ...
    def __init__(self, model_path: str = "data/136773.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb136773136773Model = OtherModeldb136773
