...
"""Auto-generated BioModule wrapper for ModelDB #49305.

Source: modeldb:49305
Original: https://modeldb.science/49305
Standard: other
...
class OtherModeldb49305(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #49305.
    ...
    def __init__(self, model_path: str = "data/49305.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb4930549305Model = OtherModeldb49305
