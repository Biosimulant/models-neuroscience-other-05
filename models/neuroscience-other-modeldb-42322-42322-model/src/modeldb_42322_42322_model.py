...
"""Auto-generated BioModule wrapper for ModelDB #42322.

Source: modeldb:42322
Original: https://modeldb.science/42322
Standard: other
...
class OtherModeldb42322(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #42322.
    ...
    def __init__(self, model_path: str = "data/42322.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb4232242322Model = OtherModeldb42322
