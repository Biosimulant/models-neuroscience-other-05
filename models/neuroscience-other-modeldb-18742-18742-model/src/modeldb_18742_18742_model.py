...
"""Auto-generated BioModule wrapper for ModelDB #18742.

Source: modeldb:18742
Original: https://modeldb.science/18742
Standard: other
...
class OtherModeldb18742(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #18742.
    ...
    def __init__(self, model_path: str = "data/18742.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb1874218742Model = OtherModeldb18742
