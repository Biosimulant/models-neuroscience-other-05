...
"""Auto-generated BioModule wrapper for ModelDB #7485.

Source: modeldb:7485
Original: https://modeldb.science/7485
Standard: other
...
class OtherModeldb7485(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #7485.
    ...
    def __init__(self, model_path: str = "data/7485.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb74857485Model = OtherModeldb7485
