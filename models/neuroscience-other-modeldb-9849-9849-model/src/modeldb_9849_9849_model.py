...
"""Auto-generated BioModule wrapper for ModelDB #9849.

Source: modeldb:9849
Original: https://modeldb.science/9849
Standard: other
...
class OtherModeldb9849(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #9849.
    ...
    def __init__(self, model_path: str = "data/9849.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb98499849Model = OtherModeldb9849
