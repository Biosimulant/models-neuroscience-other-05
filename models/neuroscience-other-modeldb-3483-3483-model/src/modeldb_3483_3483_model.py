...
"""Auto-generated BioModule wrapper for ModelDB #3483.

Source: modeldb:3483
Original: https://modeldb.science/3483
Standard: other
...
class OtherModeldb3483(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3483.
    ...
    def __init__(self, model_path: str = "data/3483.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb34833483Model = OtherModeldb3483
