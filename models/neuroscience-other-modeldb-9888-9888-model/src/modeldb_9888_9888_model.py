...
"""Auto-generated BioModule wrapper for ModelDB #9888.

Source: modeldb:9888
Original: https://modeldb.science/9888
Standard: other
...
class OtherModeldb9888(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #9888.
    ...
    def __init__(self, model_path: str = "data/9888.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb98889888Model = OtherModeldb9888
