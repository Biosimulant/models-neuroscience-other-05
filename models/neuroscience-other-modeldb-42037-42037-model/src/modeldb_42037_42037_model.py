...
"""Auto-generated BioModule wrapper for ModelDB #42037.

Source: modeldb:42037
Original: https://modeldb.science/42037
Standard: other
...
class OtherModeldb42037(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #42037.
    ...
    def __init__(self, model_path: str = "data/42037.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb4203742037Model = OtherModeldb42037
