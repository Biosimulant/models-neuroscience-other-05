...
"""Auto-generated BioModule wrapper for ModelDB #279.

Source: modeldb:279
Original: https://modeldb.science/279
Standard: other
...
class OtherModeldb279(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #279.
    ...
    def __init__(self, model_path: str = "data/279.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb279279Model = OtherModeldb279
