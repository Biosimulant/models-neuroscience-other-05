...
"""Auto-generated BioModule wrapper for ModelDB #39949.

Source: modeldb:39949
Original: https://modeldb.science/39949
Standard: other
...
class OtherModeldb39949(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #39949.
    ...
    def __init__(self, model_path: str = "data/39949.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb3994939949Model = OtherModeldb39949
