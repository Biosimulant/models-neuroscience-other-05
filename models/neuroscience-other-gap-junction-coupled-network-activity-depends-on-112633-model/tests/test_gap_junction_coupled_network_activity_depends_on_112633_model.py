...
"""Auto-generated tests for GapJunctionCoupledNetworkActivityDependsOn112633Model.
...
from src.gap_junction_coupled_network_activity_depends_on_112633_model import GapJunctionCoupledNetworkActivityDependsOn112633Model  # noqa: E402
from bsim.signals import BioSignal  # noqa: E402


def test_instantiation() -> None:
    module = GapJunctionCoupledNetworkActivityDependsOn112633Model()
...
def test_advance_produces_outputs() -> None:
    module = GapJunctionCoupledNetworkActivityDependsOn112633Model(min_dt=0.1)
