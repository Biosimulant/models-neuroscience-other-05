...
"""Auto-generated BioModule wrapper for ModelDB #33986.

Source: modeldb:33986
Original: https://modeldb.science/33986
Standard: other
...
class OtherModeldb33986(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #33986.
    ...
    def __init__(self, model_path: str = "data/33986.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb3398633986Model = OtherModeldb33986
