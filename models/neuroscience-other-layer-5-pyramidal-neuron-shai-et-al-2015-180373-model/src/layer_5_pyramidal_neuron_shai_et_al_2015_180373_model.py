...
"""Auto-generated BioModule wrapper for Layer 5 Pyramidal Neuron (Shai et al., 2015).

Source: modeldb:180373
Original: https://modeldb.science/180373
Standard: other
...
class OtherLayer5PyramidalNeuronShaiEtAl2015(biosim.BioModule):
    """Placeholder BioModule wrapper for: Layer 5 Pyramidal Neuron (Shai et al., 2015).
    ...
    def __init__(self, model_path: str = "data/180373.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Layer5PyramidalNeuronShaiEtAl2015180373Model = OtherLayer5PyramidalNeuronShaiEtAl2015
