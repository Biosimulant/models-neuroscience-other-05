...
"""Auto-generated BioModule wrapper for ModelDB #46839.

Source: modeldb:46839
Original: https://modeldb.science/46839
Standard: other
...
class OtherModeldb46839(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #46839.
    ...
    def __init__(self, model_path: str = "data/46839.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb4683946839Model = OtherModeldb46839
