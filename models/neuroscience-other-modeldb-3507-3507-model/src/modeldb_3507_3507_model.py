...
"""Auto-generated BioModule wrapper for ModelDB #3507.

Source: modeldb:3507
Original: https://modeldb.science/3507
Standard: other
...
class OtherModeldb3507(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3507.
    ...
    def __init__(self, model_path: str = "data/3507.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb35073507Model = OtherModeldb3507
