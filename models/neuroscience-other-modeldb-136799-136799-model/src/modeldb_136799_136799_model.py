...
"""Auto-generated BioModule wrapper for ModelDB #136799.

Source: modeldb:136799
Original: https://modeldb.science/136799
Standard: other
...
class OtherModeldb136799(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #136799.
    ...
    def __init__(self, model_path: str = "data/136799.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb136799136799Model = OtherModeldb136799
