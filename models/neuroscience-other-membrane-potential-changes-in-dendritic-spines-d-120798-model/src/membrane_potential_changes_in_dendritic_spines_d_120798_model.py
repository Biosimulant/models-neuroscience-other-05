...
"""Auto-generated BioModule wrapper for Membrane potential changes in dendritic spines during APs and synaptic input (Palmer & Stuart 2009).

Source: modeldb:120798
Original: https://modeldb.science/120798
Standard: other
...
class OtherMembranePotentialChangesInDendriticSpinesDuringAps(bsim.BioModule):
    """Placeholder BioModule wrapper for: Membrane potential changes in dendritic spines during APs and synaptic input (Palmer & Stuart 2009).
...
MembranePotentialChangesInDendriticSpinesD120798Model = OtherMembranePotentialChangesInDendriticSpinesDuringAps
