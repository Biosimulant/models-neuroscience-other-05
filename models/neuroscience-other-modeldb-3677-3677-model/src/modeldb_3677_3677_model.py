...
"""Auto-generated BioModule wrapper for ModelDB #3677.

Source: modeldb:3677
Original: https://modeldb.science/3677
Standard: other
...
class OtherModeldb3677(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3677.
    ...
    def __init__(self, model_path: str = "data/3677.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb36773677Model = OtherModeldb3677
