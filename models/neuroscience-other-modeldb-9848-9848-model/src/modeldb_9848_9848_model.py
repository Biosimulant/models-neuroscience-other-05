...
"""Auto-generated BioModule wrapper for ModelDB #9848.

Source: modeldb:9848
Original: https://modeldb.science/9848
Standard: other
...
class OtherModeldb9848(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #9848.
    ...
    def __init__(self, model_path: str = "data/9848.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb98489848Model = OtherModeldb9848
