...
"""Auto-generated BioModule wrapper for ModelDB #44972.

Source: modeldb:44972
Original: https://modeldb.science/44972
Standard: other
...
class OtherModeldb44972(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #44972.
    ...
    def __init__(self, model_path: str = "data/44972.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb4497244972Model = OtherModeldb44972
