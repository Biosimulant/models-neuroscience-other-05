...
"""Auto-generated BioModule wrapper for ModelDB #19696.

Source: modeldb:19696
Original: https://modeldb.science/19696
Standard: other
...
class OtherModeldb19696(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #19696.
    ...
    def __init__(self, model_path: str = "data/19696.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb1969619696Model = OtherModeldb19696
