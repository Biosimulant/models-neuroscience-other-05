...
"""Auto-generated BioModule wrapper for ModelDB #42022.

Source: modeldb:42022
Original: https://modeldb.science/42022
Standard: other
...
class OtherModeldb42022(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #42022.
    ...
    def __init__(self, model_path: str = "data/42022.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb4202242022Model = OtherModeldb42022
