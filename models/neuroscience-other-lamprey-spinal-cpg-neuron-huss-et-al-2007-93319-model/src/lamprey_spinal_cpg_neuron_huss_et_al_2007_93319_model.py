...
"""Auto-generated BioModule wrapper for Lamprey spinal CPG neuron (Huss et al. 2007).

Source: modeldb:93319
Original: https://modeldb.science/93319
Standard: other
...
class OtherLampreySpinalCpgNeuronHussEtAl2007(biosim.BioModule):
    """Placeholder BioModule wrapper for: Lamprey spinal CPG neuron (Huss et al. 2007).
    ...
    def __init__(self, model_path: str = "data/93319.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
LampreySpinalCpgNeuronHussEtAl200793319Model = OtherLampreySpinalCpgNeuronHussEtAl2007
