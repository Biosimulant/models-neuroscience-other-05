...
"""Auto-generated BioModule wrapper for Integrate and fire model code for spike-based coincidence-detection (Heinz et al. 2001, others).

Source: modeldb:126052
Original: https://modeldb.science/126052
Standard: other
...
class OtherIntegrateAndFireModelCodeForSpikeBasedCoincidence(bsim.BioModule):
    """Placeholder BioModule wrapper for: Integrate and fire model code for spike-based coincidence-detection (Heinz et al. 2001, others).
...
IntegrateAndFireModelCodeForSpikeBasedCo126052Model = OtherIntegrateAndFireModelCodeForSpikeBasedCoincidence
