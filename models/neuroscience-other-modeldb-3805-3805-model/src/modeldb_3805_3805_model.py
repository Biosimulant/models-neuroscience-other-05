...
"""Auto-generated BioModule wrapper for ModelDB #3805.

Source: modeldb:3805
Original: https://modeldb.science/3805
Standard: other
...
class OtherModeldb3805(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3805.
    ...
    def __init__(self, model_path: str = "data/3805.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb38053805Model = OtherModeldb3805
