...
"""Auto-generated BioModule wrapper for ModelDB #8284.

Source: modeldb:8284
Original: https://modeldb.science/8284
Standard: other
...
class OtherModeldb8284(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #8284.
    ...
    def __init__(self, model_path: str = "data/8284.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb82848284Model = OtherModeldb8284
