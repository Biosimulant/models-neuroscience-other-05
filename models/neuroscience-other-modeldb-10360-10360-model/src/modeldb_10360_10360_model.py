...
"""Auto-generated BioModule wrapper for ModelDB #10360.

Source: modeldb:10360
Original: https://modeldb.science/10360
Standard: other
...
class OtherModeldb10360(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #10360.
    ...
    def __init__(self, model_path: str = "data/10360.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb1036010360Model = OtherModeldb10360
