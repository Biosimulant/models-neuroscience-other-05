...
"""Auto-generated BioModule wrapper for ModelDB #42047.

Source: modeldb:42047
Original: https://modeldb.science/42047
Standard: other
...
class OtherModeldb42047(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #42047.
    ...
    def __init__(self, model_path: str = "data/42047.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb4204742047Model = OtherModeldb42047
