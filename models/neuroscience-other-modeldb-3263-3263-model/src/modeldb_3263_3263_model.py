...
"""Auto-generated BioModule wrapper for ModelDB #3263.

Source: modeldb:3263
Original: https://modeldb.science/3263
Standard: other
...
class OtherModeldb3263(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3263.
    ...
    def __init__(self, model_path: str = "data/3263.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb32633263Model = OtherModeldb3263
