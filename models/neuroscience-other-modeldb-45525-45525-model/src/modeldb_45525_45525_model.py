...
"""Auto-generated BioModule wrapper for ModelDB #45525.

Source: modeldb:45525
Original: https://modeldb.science/45525
Standard: other
...
class OtherModeldb45525(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #45525.
    ...
    def __init__(self, model_path: str = "data/45525.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb4552545525Model = OtherModeldb45525
