...
"""Auto-generated BioModule wrapper for ModelDB #7386.

Source: modeldb:7386
Original: https://modeldb.science/7386
Standard: other
...
class OtherModeldb7386(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #7386.
    ...
    def __init__(self, model_path: str = "data/7386.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb73867386Model = OtherModeldb7386
