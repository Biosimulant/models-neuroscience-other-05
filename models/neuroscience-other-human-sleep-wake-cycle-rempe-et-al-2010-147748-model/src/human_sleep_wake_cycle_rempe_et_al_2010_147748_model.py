...
"""Auto-generated BioModule wrapper for Human sleep/wake cycle (Rempe et al. 2010).

Source: modeldb:147748
Original: https://modeldb.science/147748
Standard: other
...
class OtherHumanSleepWakeCycleRempeEtAl2010(biosim.BioModule):
    """Placeholder BioModule wrapper for: Human sleep/wake cycle (Rempe et al. 2010).
    ...
    def __init__(self, model_path: str = "data/147748.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
HumanSleepWakeCycleRempeEtAl2010147748Model = OtherHumanSleepWakeCycleRempeEtAl2010
