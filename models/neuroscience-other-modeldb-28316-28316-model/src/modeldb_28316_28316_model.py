...
"""Auto-generated BioModule wrapper for ModelDB #28316.

Source: modeldb:28316
Original: https://modeldb.science/28316
Standard: other
...
class OtherModeldb28316(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #28316.
    ...
    def __init__(self, model_path: str = "data/28316.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb2831628316Model = OtherModeldb28316
