...
"""Auto-generated BioModule wrapper for ModelDB #3533.

Source: modeldb:3533
Original: https://modeldb.science/3533
Standard: other
...
class OtherModeldb3533(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3533.
    ...
    def __init__(self, model_path: str = "data/3533.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb35333533Model = OtherModeldb3533
