...
"""Auto-generated BioModule wrapper for ModelDB #19022.

Source: modeldb:19022
Original: https://modeldb.science/19022
Standard: other
...
class OtherModeldb19022(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #19022.
    ...
    def __init__(self, model_path: str = "data/19022.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb1902219022Model = OtherModeldb19022
