...
"""Auto-generated BioModule wrapper for ModelDB #3807.

Source: modeldb:3807
Original: https://modeldb.science/3807
Standard: other
...
class OtherModeldb3807(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3807.
    ...
    def __init__(self, model_path: str = "data/3807.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb38073807Model = OtherModeldb3807
