...
"""Auto-generated BioModule wrapper for ModelDB #19214.

Source: modeldb:19214
Original: https://modeldb.science/19214
Standard: other
...
class OtherModeldb19214(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #19214.
    ...
    def __init__(self, model_path: str = "data/19214.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb1921419214Model = OtherModeldb19214
