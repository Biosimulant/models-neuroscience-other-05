...
"""Auto-generated BioModule wrapper for ModelDB #17664.

Source: modeldb:17664
Original: https://modeldb.science/17664
Standard: other
...
class OtherModeldb17664(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #17664.
    ...
    def __init__(self, model_path: str = "data/17664.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb1766417664Model = OtherModeldb17664
