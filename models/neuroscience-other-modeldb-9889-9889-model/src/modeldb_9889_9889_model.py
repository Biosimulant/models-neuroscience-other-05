...
"""Auto-generated BioModule wrapper for ModelDB #9889.

Source: modeldb:9889
Original: https://modeldb.science/9889
Standard: other
...
class OtherModeldb9889(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #9889.
    ...
    def __init__(self, model_path: str = "data/9889.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb98899889Model = OtherModeldb9889
