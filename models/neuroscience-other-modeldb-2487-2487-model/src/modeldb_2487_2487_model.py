...
"""Auto-generated BioModule wrapper for ModelDB #2487.

Source: modeldb:2487
Original: https://modeldb.science/2487
Standard: other
...
class OtherModeldb2487(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #2487.
    ...
    def __init__(self, model_path: str = "data/2487.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb24872487Model = OtherModeldb2487
