...
"""Auto-generated BioModule wrapper for ModelDB #3332.

Source: modeldb:3332
Original: https://modeldb.science/3332
Standard: other
...
class OtherModeldb3332(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3332.
    ...
    def __init__(self, model_path: str = "data/3332.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb33323332Model = OtherModeldb3332
