...
"""Auto-generated BioModule wrapper for Markov models of SCN1A (NaV1.1) applied to abnormal gating and epilepsy (Clancy and Kass 2004).

Source: modeldb:87278
Original: https://modeldb.science/87278
Standard: other
...
class OtherMarkovModelsOfScn1aNav11AppliedToAbnormalGating(biosim.BioModule):
    """BioModule wrapper for: Markov models of SCN1A (NaV1.1) applied to abnormal gating and epilepsy (Clancy and Kass 2004).""""""

    def __init__(self, model_path: str = "data/87278.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MarkovModelsOfScn1aNav11AppliedToAbnorma87278Model = OtherMarkovModelsOfScn1aNav11AppliedToAbnormalGating
