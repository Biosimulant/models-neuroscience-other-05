...
"""Auto-generated BioModule wrapper for ModelDB #7907.

Source: modeldb:7907
Original: https://modeldb.science/7907
Standard: other
...
class OtherModeldb7907(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #7907.
    ...
    def __init__(self, model_path: str = "data/7907.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb79077907Model = OtherModeldb7907
