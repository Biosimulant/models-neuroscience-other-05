...
"""Auto-generated BioModule wrapper for Inhibitory control by an integral feedback signal in prefrontal cortex (Miller and Wang 2006).

Source: modeldb:62268
Original: https://modeldb.science/62268
Standard: other
...
class OtherInhibitoryControlByAnIntegralFeedbackSignalIn(bsim.BioModule):
    """Placeholder BioModule wrapper for: Inhibitory control by an integral feedback signal in prefrontal cortex (Miller and Wang 2006).
...
InhibitoryControlByAnIntegralFeedbackSigna62268Model = OtherInhibitoryControlByAnIntegralFeedbackSignalIn
