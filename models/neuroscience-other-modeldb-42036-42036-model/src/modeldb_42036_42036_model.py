...
"""Auto-generated BioModule wrapper for ModelDB #42036.

Source: modeldb:42036
Original: https://modeldb.science/42036
Standard: other
...
class OtherModeldb42036(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #42036.
    ...
    def __init__(self, model_path: str = "data/42036.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb4203642036Model = OtherModeldb42036
