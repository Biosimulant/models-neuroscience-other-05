...
"""Auto-generated BioModule wrapper for ModelDB #17663.

Source: modeldb:17663
Original: https://modeldb.science/17663
Standard: other
...
class OtherModeldb17663(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #17663.
    ...
    def __init__(self, model_path: str = "data/17663.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb1766317663Model = OtherModeldb17663
