...
"""Auto-generated BioModule wrapper for ModelDB #2796.

Source: modeldb:2796
Original: https://modeldb.science/2796
Standard: other
...
class OtherModeldb2796(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #2796.
    ...
    def __init__(self, model_path: str = "data/2796.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb27962796Model = OtherModeldb2796
