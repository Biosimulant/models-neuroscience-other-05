...
"""Auto-generated BioModule wrapper for ModelDB #37436.

Source: modeldb:37436
Original: https://modeldb.science/37436
Standard: other
...
class OtherModeldb37436(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #37436.
    ...
    def __init__(self, model_path: str = "data/37436.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb3743637436Model = OtherModeldb37436
