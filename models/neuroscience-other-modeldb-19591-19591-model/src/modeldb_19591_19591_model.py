...
"""Auto-generated BioModule wrapper for ModelDB #19591.

Source: modeldb:19591
Original: https://modeldb.science/19591
Standard: other
...
class OtherModeldb19591(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #19591.
    ...
    def __init__(self, model_path: str = "data/19591.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb1959119591Model = OtherModeldb19591
