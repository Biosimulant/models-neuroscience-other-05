...
"""Auto-generated BioModule wrapper for ModelDB #34560.

Source: modeldb:34560
Original: https://modeldb.science/34560
Standard: other
...
class OtherModeldb34560(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #34560.
    ...
    def __init__(self, model_path: str = "data/34560.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb3456034560Model = OtherModeldb34560
