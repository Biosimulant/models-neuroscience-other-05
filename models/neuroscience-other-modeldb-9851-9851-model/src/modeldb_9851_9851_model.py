...
"""Auto-generated BioModule wrapper for ModelDB #9851.

Source: modeldb:9851
Original: https://modeldb.science/9851
Standard: other
...
class OtherModeldb9851(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #9851.
    ...
    def __init__(self, model_path: str = "data/9851.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb98519851Model = OtherModeldb9851
