...
"""Auto-generated BioModule wrapper for ModelDB #19920.

Source: modeldb:19920
Original: https://modeldb.science/19920
Standard: other
...
class OtherModeldb19920(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #19920.
    ...
    def __init__(self, model_path: str = "data/19920.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb1992019920Model = OtherModeldb19920
