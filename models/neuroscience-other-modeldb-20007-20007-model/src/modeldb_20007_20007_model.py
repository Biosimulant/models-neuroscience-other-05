...
"""Auto-generated BioModule wrapper for ModelDB #20007.

Source: modeldb:20007
Original: https://modeldb.science/20007
Standard: other
...
class OtherModeldb20007(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #20007.
    ...
    def __init__(self, model_path: str = "data/20007.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb2000720007Model = OtherModeldb20007
