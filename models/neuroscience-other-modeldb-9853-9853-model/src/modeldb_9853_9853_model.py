...
"""Auto-generated BioModule wrapper for ModelDB #9853.

Source: modeldb:9853
Original: https://modeldb.science/9853
Standard: other
...
class OtherModeldb9853(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #9853.
    ...
    def __init__(self, model_path: str = "data/9853.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb98539853Model = OtherModeldb9853
