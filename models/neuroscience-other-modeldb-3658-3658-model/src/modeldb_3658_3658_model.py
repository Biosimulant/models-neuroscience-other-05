...
"""Auto-generated BioModule wrapper for ModelDB #3658.

Source: modeldb:3658
Original: https://modeldb.science/3658
Standard: other
...
class OtherModeldb3658(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3658.
    ...
    def __init__(self, model_path: str = "data/3658.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb36583658Model = OtherModeldb3658
