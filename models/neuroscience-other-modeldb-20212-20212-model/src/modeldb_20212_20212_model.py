...
"""Auto-generated BioModule wrapper for ModelDB #20212.

Source: modeldb:20212
Original: https://modeldb.science/20212
Standard: other
...
class OtherModeldb20212(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #20212.
    ...
    def __init__(self, model_path: str = "data/20212.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb2021220212Model = OtherModeldb20212
