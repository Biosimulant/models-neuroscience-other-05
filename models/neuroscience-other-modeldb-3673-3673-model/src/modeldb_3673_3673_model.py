...
"""Auto-generated BioModule wrapper for ModelDB #3673.

Source: modeldb:3673
Original: https://modeldb.science/3673
Standard: other
...
class OtherModeldb3673(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3673.
    ...
    def __init__(self, model_path: str = "data/3673.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb36733673Model = OtherModeldb3673
