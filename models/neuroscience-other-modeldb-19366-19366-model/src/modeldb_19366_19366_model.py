...
"""Auto-generated BioModule wrapper for ModelDB #19366.

Source: modeldb:19366
Original: https://modeldb.science/19366
Standard: other
...
class OtherModeldb19366(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #19366.
    ...
    def __init__(self, model_path: str = "data/19366.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb1936619366Model = OtherModeldb19366
