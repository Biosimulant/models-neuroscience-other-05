...
"""Auto-generated BioModule wrapper for ModelDB #48332.

Source: modeldb:48332
Original: https://modeldb.science/48332
Standard: other
...
class OtherModeldb48332(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #48332.
    ...
    def __init__(self, model_path: str = "data/48332.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb4833248332Model = OtherModeldb48332
