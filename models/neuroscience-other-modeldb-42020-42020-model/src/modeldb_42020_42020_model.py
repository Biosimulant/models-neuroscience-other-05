...
"""Auto-generated BioModule wrapper for ModelDB #42020.

Source: modeldb:42020
Original: https://modeldb.science/42020
Standard: other
...
class OtherModeldb42020(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #42020.
    ...
    def __init__(self, model_path: str = "data/42020.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb4202042020Model = OtherModeldb42020
