...
"""Auto-generated BioModule wrapper for ModelDB #20015.

Source: modeldb:20015
Original: https://modeldb.science/20015
Standard: other
...
class OtherModeldb20015(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #20015.
    ...
    def __init__(self, model_path: str = "data/20015.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb2001520015Model = OtherModeldb20015
