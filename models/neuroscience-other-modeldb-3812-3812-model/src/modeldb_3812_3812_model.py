...
"""Auto-generated BioModule wrapper for ModelDB #3812.

Source: modeldb:3812
Original: https://modeldb.science/3812
Standard: other
...
class OtherModeldb3812(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3812.
    ...
    def __init__(self, model_path: str = "data/3812.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb38123812Model = OtherModeldb3812
