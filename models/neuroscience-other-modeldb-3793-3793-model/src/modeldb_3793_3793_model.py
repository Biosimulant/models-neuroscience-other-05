...
"""Auto-generated BioModule wrapper for ModelDB #3793.

Source: modeldb:3793
Original: https://modeldb.science/3793
Standard: other
...
class OtherModeldb3793(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3793.
    ...
    def __init__(self, model_path: str = "data/3793.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb37933793Model = OtherModeldb3793
