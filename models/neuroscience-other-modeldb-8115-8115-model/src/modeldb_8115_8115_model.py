...
"""Auto-generated BioModule wrapper for ModelDB #8115.

Source: modeldb:8115
Original: https://modeldb.science/8115
Standard: other
...
class OtherModeldb8115(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #8115.
    ...
    def __init__(self, model_path: str = "data/8115.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb81158115Model = OtherModeldb8115
