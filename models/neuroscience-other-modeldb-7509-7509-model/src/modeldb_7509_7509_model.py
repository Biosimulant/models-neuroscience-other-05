...
"""Auto-generated BioModule wrapper for ModelDB #7509.

Source: modeldb:7509
Original: https://modeldb.science/7509
Standard: other
...
class OtherModeldb7509(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #7509.
    ...
    def __init__(self, model_path: str = "data/7509.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb75097509Model = OtherModeldb7509
