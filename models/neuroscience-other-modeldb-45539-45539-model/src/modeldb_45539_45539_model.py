...
"""Auto-generated BioModule wrapper for ModelDB #45539.

Source: modeldb:45539
Original: https://modeldb.science/45539
Standard: other
...
class OtherModeldb45539(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #45539.
    ...
    def __init__(self, model_path: str = "data/45539.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb4553945539Model = OtherModeldb45539
