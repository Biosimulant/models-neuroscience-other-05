...
"""Auto-generated BioModule wrapper for ModelDB #42323.

Source: modeldb:42323
Original: https://modeldb.science/42323
Standard: other
...
class OtherModeldb42323(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #42323.
    ...
    def __init__(self, model_path: str = "data/42323.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb4232342323Model = OtherModeldb42323
