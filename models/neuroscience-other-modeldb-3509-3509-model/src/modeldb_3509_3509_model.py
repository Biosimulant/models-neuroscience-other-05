...
"""Auto-generated BioModule wrapper for ModelDB #3509.

Source: modeldb:3509
Original: https://modeldb.science/3509
Standard: other
...
class OtherModeldb3509(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3509.
    ...
    def __init__(self, model_path: str = "data/3509.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb35093509Model = OtherModeldb3509
