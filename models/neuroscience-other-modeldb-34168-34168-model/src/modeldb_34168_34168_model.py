...
"""Auto-generated BioModule wrapper for ModelDB #34168.

Source: modeldb:34168
Original: https://modeldb.science/34168
Standard: other
...
class OtherModeldb34168(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #34168.
    ...
    def __init__(self, model_path: str = "data/34168.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb3416834168Model = OtherModeldb34168
