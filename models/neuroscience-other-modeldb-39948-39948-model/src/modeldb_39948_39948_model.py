...
"""Auto-generated BioModule wrapper for ModelDB #39948.

Source: modeldb:39948
Original: https://modeldb.science/39948
Standard: other
...
class OtherModeldb39948(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #39948.
    ...
    def __init__(self, model_path: str = "data/39948.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb3994839948Model = OtherModeldb39948
