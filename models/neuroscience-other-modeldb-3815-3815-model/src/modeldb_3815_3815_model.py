...
"""Auto-generated BioModule wrapper for ModelDB #3815.

Source: modeldb:3815
Original: https://modeldb.science/3815
Standard: other
...
class OtherModeldb3815(biosim.BioModule):
    """Placeholder BioModule wrapper for: ModelDB #3815.
    ...
    def __init__(self, model_path: str = "data/3815.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Modeldb38153815Model = OtherModeldb3815
